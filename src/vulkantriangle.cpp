...
private:
    ...
    void createSwapChain() {
        ...
        // use minImageCount + 1 unless it exceeds maxImageCount
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
        ...
        actualExtent.width = std::max(std::min(actualExtent.width, capabilities.maxImageExtent.width), capabilities.minImageExtent.width);
        actualExtent.height = std::max(std::min(actualExtent.height, capabilities.maxImageExtent.height), capabilities.minImageExtent.height);
